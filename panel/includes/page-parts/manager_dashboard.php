                    ...
                    <div class="tab-menu-heading">
                        <div class="tabs-menu">
                            ...
                            <ul class="nav panel-tabs panel-secondary">
                                <li><a href="#total" class="active" data-bs-toggle="tab"><span><i class="fe fe-user me-1"></i></span>Total</a></li>
                                ...
                                <div class="row mb-4 agent_sales" >
                                    ...
                                    <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                        <div class="d-flex align-items-end justify-content-between mb-1">
                                            <h6 class="mb-1"><b><?php echo $agents['agent_name'];?>  (Total Sales:<?php echo get_total_sales_of_agents($agents['agent_id']); ?>)</b>&nbsp;<span class="rounded-pill badge '.$bg.' ms-3 px-2 pb-1 mb-1"><?php echo get_total_sales_of_agents($agents['user_id']);?></span></h6>
