                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-sm-6 col-md-4 reveal revealleft">
                                            ...
                                            <ul class="list-unstyled mb-5 mb-lg-0">
                                                ...
                                                <li><a href="alerts.php">Elements</a></li>
                                                <li><a href="form-elements.php">Forms</a></li>
                                                <li><a href="charts.php">Charts</a></li>
                                                <li><a href="datatable.php">Tables</a></li>
                                                <li><a href="file-attachments.php">Other Pages</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-lg-2 col-sm-6 col-md-4 reveal revealleft">
                                            <h6>Information</h6>
                                            <ul class="list-unstyled mb-5 mb-lg-0">
                                                ...
                                                <li><a href="terms.php">Terms and Services</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-lg-4 col-sm-12 col-md-4 reveal revealleft">
                                            <div class="">
                                                ...
                                                <a href="index.php"><img src="../assets/images/brand/logo.png"
