<?php
	...
	$admin_details = DB::Query("SELECT * FROM super_admins WHERE user_id = $user_id");
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
									...
									<div class="card-header">
                                            <h3 class="card-title" style="width: 100%;"><i class="fa fa-2x fa-building"></i>Edit Super Admin Profile</h3>
                                        ...
                                        <div class="card-body">
										<form action="index.php?route=modules/roles/process_profile" method="POST">
                                            <div class="row">
											...
											<div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-12">
												<div class="form-group">
													<label for="user_phone">User Title:</label> 
													<input type="phone" name="user_title" class="form-control"  id="user_title" value="<?php echo $admin_details[0]['user_title']; ?>" />
												</div>
                                                </div>
                                            </div>				
											<div class="form-group">
